...
while True:
    ...
    if button[0].is_pressed:
        draw.text((x, top), "Pressure and Acceleration", font=font, fill=255)
        draw.text((x, top + 8), "Measurement", font=font, fill=255)
        ...
        C3 = data[0] * 256 + data[1]  # Read temperature coefficient of pressure offset
    ...
    if button[1].is_pressed:
        draw.rectangle((0, 0, width, height), outline=0, fill=0)
        draw.text((x, top), " Program", font=font, fill=255)
        draw.text((x, top + 8), "   Freezed", font=font, fill=255)
        disp.image(image)
        disp.display()
        draw.text(
            (x, top),
    ...
    if button[2].is_pressed:
        draw.rectangle((0, 0, width, height), outline=0, fill=0)
        draw.text((x, top), " Program", font=font, fill=255)
        draw.text((x, top + 8), "    Stopped", font=font, fill=255)
        draw.text(
            (x, top),
            "Status= " + "Stop",
            font=font,
